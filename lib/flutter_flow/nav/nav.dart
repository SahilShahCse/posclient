...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'in_entry',
          path: '/inEntry',
          builder: (context, params) => InEntryWidget(
            carduid: params.getParam(
              'carduid',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'OUT_entry',
          path: '/oUTEntry',
          builder: (context, params) => OUTEntryWidget(
            carduid: params.getParam(
              'carduid',
              ParamType.String,
            ),
            showticket: params.getParam(
              'showticket',
              ParamType.bool,
            ),
          ),
        ...
        FFRoute(
          name: 'qrcodegen',
          path: '/qrcodegen',
          builder: (context, params) => QrcodegenWidget(),
        )
